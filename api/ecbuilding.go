...
func batchUpsertEcbuildingHandler(w http.ResponseWriter, r *http.Request) {
	...
	err = common.DbBatchUpsert[model.Ecbuilding](r.Context(), common.GetDaprClient(), entities, model.EcbuildingTableInfo.Name, model.Ecbuilding_FIELD_NAME_id)
	if err != nil {
