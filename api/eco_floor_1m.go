...
func batchUpsertEco_floor_1mHandler(w http.ResponseWriter, r *http.Request) {
	...
	var entities []model.Eco_floor_1m
	...
	err = common.DbBatchUpsert[model.Eco_floor_1m](r.Context(), common.GetDaprClient(), entities, model.Eco_floor_1mTableInfo.Name, model.Eco_floor_1m_FIELD_NAME_id)
	if err != nil {
