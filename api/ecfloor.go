...
func batchUpsertEcfloorHandler(w http.ResponseWriter, r *http.Request) {
	...
	err = common.DbBatchUpsert[model.Ecfloor](r.Context(), common.GetDaprClient(), entities, model.EcfloorTableInfo.Name, model.Ecfloor_FIELD_NAME_id)
	if err != nil {
