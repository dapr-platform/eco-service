...
func batchUpsertEco_gateway_1hHandler(w http.ResponseWriter, r *http.Request) {
	...
	var entities []model.Eco_gateway_1h
	...
	err = common.DbBatchUpsert[model.Eco_gateway_1h](r.Context(), common.GetDaprClient(), entities, model.Eco_gateway_1hTableInfo.Name, model.Eco_gateway_1h_FIELD_NAME_id)
	if err != nil {
