...
func batchUpsertEco_gateway_1mHandler(w http.ResponseWriter, r *http.Request) {
	...
	var entities []model.Eco_gateway_1m
	...
	err = common.DbBatchUpsert[model.Eco_gateway_1m](r.Context(), common.GetDaprClient(), entities, model.Eco_gateway_1mTableInfo.Name, model.Eco_gateway_1m_FIELD_NAME_id)
	if err != nil {
