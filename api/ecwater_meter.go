...
func batchUpsertEcwater_meterHandler(w http.ResponseWriter, r *http.Request) {
	...
	var entities []model.Ecwater_meter
	...
	err = common.DbBatchUpsert[model.Ecwater_meter](r.Context(), common.GetDaprClient(), entities, model.Ecwater_meterTableInfo.Name, model.Ecwater_meter_FIELD_NAME_id)
	if err != nil {
