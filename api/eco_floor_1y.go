...
func batchUpsertEco_floor_1yHandler(w http.ResponseWriter, r *http.Request) {
	...
	var entities []model.Eco_floor_1y
	...
	err = common.DbBatchUpsert[model.Eco_floor_1y](r.Context(), common.GetDaprClient(), entities, model.Eco_floor_1yTableInfo.Name, model.Eco_floor_1y_FIELD_NAME_id)
	if err != nil {
