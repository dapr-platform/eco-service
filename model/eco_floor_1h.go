...
JSON Sample
-------------------------------------
{    "time": 79,    "floor_id": "fYOOOlIqpDunJpKOybHmDijXc",    "building_id": "IOESppvedFMrcBuskKBTUYdLG",    "park_id": "tkVwFsirgfImSTZgJZwSdKpGl",    "type": 85,    "power_consumption": 0.20623295428129715}


Comments
-------------------------------------
[ 0] Warning table: f_eco_floor_1h does not have a primary key defined, setting col position 1 time as primary key
Warning table: f_eco_floor_1h primary key column time is nullable column, setting it as NOT NULL
...
var (
	Eco_floor_1h_FIELD_NAME_time = "time"

	Eco_floor_1h_FIELD_NAME_floor_id = "floor_id"

	Eco_floor_1h_FIELD_NAME_building_id = "building_id"

	Eco_floor_1h_FIELD_NAME_park_id = "park_id"

	Eco_floor_1h_FIELD_NAME_type = "type"

	Eco_floor_1h_FIELD_NAME_power_consumption = "power_consumption"
)

// Eco_floor_1h struct is a row record of the f_eco_floor_1h table in the  database
type Eco_floor_1h struct {
...
var Eco_floor_1hTableInfo = &TableInfo{
	Name: "f_eco_floor_1h",
	Columns: []*ColumnInfo{
		...
		&ColumnInfo{
			...
			Name:    "time",
			Comment: `time`,
			Notes: `Warning table: f_eco_floor_1h does not have a primary key defined, setting col position 1 time as primary key
Warning table: f_eco_floor_1h primary key column time is nullable column, setting it as NOT NULL
`,
			Nullable:           false,
...
func (e *Eco_floor_1h) TableName() string {
	return "f_eco_floor_1h"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (e *Eco_floor_1h) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (e *Eco_floor_1h) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (e *Eco_floor_1h) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (e *Eco_floor_1h) TableInfo() *TableInfo {
	return Eco_floor_1hTableInfo
}
