...
JSON Sample
-------------------------------------
{    "time": 86,    "floor_id": "BiXMqUbAxfUxCvdclUSglNexR",    "building_id": "HwBtxTHTSrVfPdruUXGKUeQmM",    "park_id": "cveRyODDlERrUUhVCUVOYijiB",    "type": 28,    "power_consumption": 0.8493681361355535}


Comments
-------------------------------------
[ 0] Warning table: f_eco_floor_1y does not have a primary key defined, setting col position 1 time as primary key
Warning table: f_eco_floor_1y primary key column time is nullable column, setting it as NOT NULL
...
var (
	Eco_floor_1y_FIELD_NAME_time = "time"

	Eco_floor_1y_FIELD_NAME_floor_id = "floor_id"

	Eco_floor_1y_FIELD_NAME_building_id = "building_id"

	Eco_floor_1y_FIELD_NAME_park_id = "park_id"

	Eco_floor_1y_FIELD_NAME_type = "type"

	Eco_floor_1y_FIELD_NAME_power_consumption = "power_consumption"
)

// Eco_floor_1y struct is a row record of the f_eco_floor_1y table in the  database
type Eco_floor_1y struct {
...
var Eco_floor_1yTableInfo = &TableInfo{
	Name: "f_eco_floor_1y",
	Columns: []*ColumnInfo{
		...
		&ColumnInfo{
			...
			Name:    "time",
			Comment: `time`,
			Notes: `Warning table: f_eco_floor_1y does not have a primary key defined, setting col position 1 time as primary key
Warning table: f_eco_floor_1y primary key column time is nullable column, setting it as NOT NULL
`,
			Nullable:           false,
...
func (e *Eco_floor_1y) TableName() string {
	return "f_eco_floor_1y"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (e *Eco_floor_1y) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (e *Eco_floor_1y) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (e *Eco_floor_1y) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (e *Eco_floor_1y) TableInfo() *TableInfo {
	return Eco_floor_1yTableInfo
}
