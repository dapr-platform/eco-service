...
JSON Sample
-------------------------------------
{    "time": 47,    "park_id": "EIvaoRSdDdmMpdRWTHRjqIfqN",    "type": 41,    "water_consumption": 0.3488112049291292}


Comments
-------------------------------------
[ 0] Warning table: f_eco_park_water_1d does not have a primary key defined, setting col position 1 time as primary key
Warning table: f_eco_park_water_1d primary key column time is nullable column, setting it as NOT NULL
...
var (
	Eco_park_water_1d_FIELD_NAME_time = "time"
...
// Eco_park_water_1d struct is a row record of the f_eco_park_water_1d table in the  database
...
var Eco_park_water_1dTableInfo = &TableInfo{
	Name: "f_eco_park_water_1d",
	Columns: []*ColumnInfo{
		...
		&ColumnInfo{
			...
			Name:    "time",
			Comment: `time`,
			Notes: `Warning table: f_eco_park_water_1d does not have a primary key defined, setting col position 1 time as primary key
Warning table: f_eco_park_water_1d primary key column time is nullable column, setting it as NOT NULL
`,
			Nullable:           false,
...
func (e *Eco_park_water_1d) TableName() string {
	return "f_eco_park_water_1d"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (e *Eco_park_water_1d) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (e *Eco_park_water_1d) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (e *Eco_park_water_1d) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (e *Eco_park_water_1d) TableInfo() *TableInfo {
	return Eco_park_water_1dTableInfo
}
